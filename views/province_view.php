...
<body>
    ...
    $dis_province = $province->displayAllWithPagination($start_from, $records_per_page);

    // Get total number of records
    $total_records = $province->getTotalRecords();
                ...
                <div class="col-lg-12" style="background-color: darkgray; border-radius: 20px; width: 100%">
                    <div class="card"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                foreach ($dis_province as $province): ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="td_butt" style="text-align: end;">
                                            <a href="province_edit.php?id=<?php echo $province['id']; ?>">
                                                <button type="submit" class="btn btn-success rounded-pill"
                                                    style="cursor: pointer;">Edit</button>
                                            </a>
                                            <a href="province_delete.php?id=<?php echo $province['id']; ?>">
