...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Add Town City Table</h1>
        </div>
        <div class="card" style="width: 100%">
            <div class="card-body">
                <h5 class="card-title">Add Town Name</h5>
                <form class="row g-3 needs-validation" method="post" novalidate>
                    <div class="col-md-4">
                        <label for="validationCustom01" class="form-label">Town Name</label>
                        <input type="text" class="form-control" id="validationCustom01" name="name"
                            placeholder="E.g. West Maryjaneshire" required>
